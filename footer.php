<footer class="section-sm bg-tertiary">
	<div class="container">
		<div class="row justify-content-between">
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					<h5 class="mb-4 text-primary font-secondary" style="color: #ffc107!important;">Service</h5>
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					<h5 class="mb-4 text-primary font-secondary" style="color: #ffc107!important;">About</h5>
					<ul class="list-unstyled">
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					<h5 class="mb-4 text-primary font-secondary" style="color: #ffc107!important;">Help</h5>
					<ul class="list-unstyled">
			...
			<div class="col-lg-4 col-md-12 newsletter-form">
				<div style="background-color: #F4F4F4; padding: 35px;">
					<h5 class="mb-4 text-primary font-secondary" style="color: #ffc107!important;">Subscribe</h5>
                    ...
                    <button class="input-group-text border-0 bg-primary" type="submit" name="subscribe"
                      aria-label="Subscribe for Newsletter" style="background-color: #ffc107!important;"><i class="fas fa-arrow-right"></i></button>
                  </span>
							</div>
		...
		<div class="row align-items-center mt-5 text-center text-md-start">
			<div class="col-lg-4">
        <a href="index.html">
          <h4 style="color: black!important;">Game Trading</h4>
        </a>
			</div>
